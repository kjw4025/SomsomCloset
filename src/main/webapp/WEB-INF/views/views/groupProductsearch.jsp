               ...
               <table class="type_list">
                  ...
                  <tbody id="searchList>">
                     <c:forEach items="${list}" var="list">
                        <tr>
                           <td class="image">
                              <div class="image_wrap" data-productId="${list.imageList[0].groupProductId}" data-path="${list.imageList[0].uploadPath}" data-uuid="${list.imageList[0].uuid}" data-filename="${list.imageList[0].fileName}">
                                 <img>
                              </div>                              
                           </td>
                           <td class="detail">
                              ...
                              <div class="title">
                                 <c:choose> 
                                    <c:when test="${list.groupProductCK == 1}">                                                               
                                       <a href="/groupProductDetail/${list.groupProductId}">
                                          <del>${list.groupProductName}</del>(공구 종료)
                                       </a>                        
                                    </c:when> 
                                    <c:otherwise>                                        
                                       <a href="/groupProductDetail/${list.groupProductId}">
                                          ${list.groupProductName}
                                       </a>                                    
                                    </c:otherwise>
                                 </c:choose> 
                                 </div>
                           ...
                           <td class="price">
                              <div class="org_price">
                                 <del>
                                    <fmt:formatNumber value="${list.groupProductPrice}" pattern="#,### 원" />
                                 </del>
                              </div>
                              <div class="sell_price">
                                 <strong>
                                    <fmt:formatNumber value="${list.groupProductPrice * (1-(list.groupProductDiscount/100))}" pattern="#,### 원" />
                                 </strong>
                              </div>
                           </td>
                           <td class="option"></td>
