...
<div class="wrapper">
	<div class="wrap">
		...
		<div class="content_area">
			...
			<!-- 주문 요청 form -->
			<form class="order_form" action="/groupOrder" method="post">
				<!-- 주문자 회원번호 -->
...
$(".order_point_input").on("propertychange change keyup paste input", function(){
	...
	var maxPoint = 0;
	if(totalPrice > parseInt('${memberInfo.point}')){
		maxPoint = parseInt('${memberInfo.point}');
	}else{
		maxPoint = totalPrice;
	}
...
$(".order_btn").on("click", function(){
	...
	if(${memberInfo.money} < finalTotalPrice){
		alert("현재 충전 금액이 결제 금액 보다 적습니다.");
	}else{
