      ...
      <div class="content_area">
         ...
         <div class="content_top">
            <div class="ct_left_area">
               <div class="image_wrap" data-productid="${goodsInfo.imageList[0].productId}" data-path="${goodsInfo.imageList[0].uploadPath}" data-uuid="${goodsInfo.imageList[0].uuid}" data-filename="${goodsInfo.imageList[0].fileName}">
                  <img>
               </div>            
            </div>
            <div class="ct_right_area">
               <div class="title">
                  <h1>
                  	<c:choose> 
						<c:when test="${goodsInfo.productStock <= 0}">	
							<del>${goodsInfo.productName}</del>(품절)																												
						</c:when> 
						<c:otherwise> 													
               ...
               <div class="price">
                  <div class="sale_price">정가 : <fmt:formatNumber value="${goodsInfo.productPrice}" pattern="#,### 원" /></div>
                     <div class="discount_price">
                        판매가 : <span class="discount_price_number"><fmt:formatNumber value="${goodsInfo.productPrice - (goodsInfo.productPrice*(goodsInfo.productDiscount/100))}" pattern="#,### 원" /></span> 
                        [<fmt:formatNumber value="${goodsInfo.productDiscount}" pattern="###" />% 
                        <fmt:formatNumber value="${goodsInfo.productPrice*goodsInfo.productDiscount/100}" pattern="#,### 원" /> 할인]
                     </div>
                     <div>
...
$(document).ready(function(){
   ...
   /* 포인트 삽입 */
   let salePrice = "${goodsInfo.productPrice - (goodsInfo.productPrice*(goodsInfo.productDiscount/100))}"
...
// 장바구니 추가 버튼
   ...
   function cartAlert(result){
	   let productStock = ${goodsInfo.productStock};
	   let quantity = $(".quantity_input").val();
